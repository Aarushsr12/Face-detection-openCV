...
void face_Detect(Mat img, CascadeClassifier faceCascade) //function for face detection
{
	faceCascade.load("haarcascade_frontalface_default.xml"); //loading xml file which helps to detect the frontal faces
